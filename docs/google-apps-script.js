...
const RSVP_TAB = 'RSVP';
const RSVP_ENDPOINT_VERSION = '2026-08-05-email-v58';
...
function sendRsvpConfirmation(email, name) {
  ...
  const inlineImages = {
    monogram: Utilities.newBlob(
      Utilities.base64Decode(EMAIL_MONOGRAM_PNG_BASE64),
      'image/png',
      'minchi-david-monogram.png'
    ),
    signature: Utilities.newBlob(
      Utilities.base64Decode(EMAIL_SIGNATURE_PNG_BASE64),
      'image/png',
      'minchi-david-signature.png'
    ),
    signatureZh: Utilities.newBlob(
      Utilities.base64Decode(EMAIL_SIGNATURE_ZH_PNG_BASE64),
      'image/png',
      'minchi-david-signature-zh.png'
    ),
  };
  ...
  const htmlBody = [
    ...
    '<div style="margin:0 0 8px;text-align:center;"><img src="cid:monogram" width="110" alt="M·D" style="display:inline-block;width:110px;max-width:100%;height:auto;border:0;"></div>',
    '<div style="margin:0 0 46px;text-align:center;font-family:\'Avenir Next\',Avenir,\'Helvetica Neue\',Arial,sans-serif;font-size:13px;font-weight:600;line-height:1.5;letter-spacing:.14em;text-transform:uppercase;color:#8f7049;">RSVP Confirmed</div>',
    ...
    '<p style="margin:0 0 26px;font-family:\'PingFang TC\',\'Noto Sans TC\',sans-serif;font-size:15px;font-weight:400;line-height:1.8;color:#37352f;">太棒了！<br>期待與你一起分享<br>這個特別的日子 &#129293;</p>',
    '<p style="margin:0 0 52px;font-family:\'PingFang TC\',\'Noto Sans TC\',sans-serif;font-size:15px;font-weight:400;line-height:1.8;color:#56514b;">婚禮前三天，<br>我們會再寄送一封 Email，<br>通知你的桌次資訊與行前提醒。</p>',
    '<p style="margin:0 0 8px;font-family:\'Avenir Next\',Avenir,\'Helvetica Neue\',Arial,sans-serif;font-size:14px;font-weight:400;line-height:1.6;color:#56514b;"><a href="' + calendarUrl + '" target="_blank" style="color:#56514b;font-weight:400;text-decoration:none;">2026.11.29</a> <span style="font-size:9px;vertical-align:1px;">&bull;</span> <a href="' + mapsUrl + '" target="_blank" style="color:#56514b;font-weight:400;text-decoration:none;">Taipei Marriott Hotel</a></p>',
    ...
    '<p style="margin:0 0 5px;text-align:left;"><img src="cid:signature" width="205" alt="Minchi &amp; David" style="display:block;width:205px;max-width:100%;height:auto;border:0;"></p>',
    '<p style="margin:0 0 0 8px;text-align:left;"><img src="cid:signatureZh" width="89" alt="旻淇・大為" style="display:block;width:89px;max-width:100%;height:auto;border:0;"></p>',
    '</td></tr></table>',
    '</td></tr></table>',
    '</div>',
    '</body>',
...
function doPost(e) {
  try {
    ...
    if (email && attendance === 'yes') {
      try {
        emailService = sendRsvpConfirmation(email, name);
        emailSent = true;
      } catch (emailError) {
